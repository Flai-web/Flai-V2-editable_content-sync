      ...
      >
        ...
        <div className="mx-5 mt-4 bg-blue-900/20 border border-blue-700/40 rounded-lg px-4 py-3 flex gap-2 shrink-0">
          ...
          <p className="text-xs text-blue-300">
            ...
            <code className="bg-neutral-800 px-1 rounded">getContent(…)</code> kald og <code className="bg-neutral-800 px-1 rounded">label: () => <EditableContent contentKey="deploy-content-manager-tekst" fallback="Tekst" /></code> i objekt-arrays.
        ...
        <div className="space-y-4 border border-neutral-600 rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 px-5">
            {[
              ...
              { label: () => <EditableContent contentKey="deploy-content-manager-filer-aendret-2" fallback="Filer ændret" />,  value: deployResult.modifiedFiles.length, color: 'text-blue-400',   icon: FileCode     },
