                ...
                {compressionMode === 'quality' && (
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      {[{ label: () => <EditableContent contentKey="image-upload-lav" fallback="Lav" />, value: 30 }, { label: () => <EditableContent contentKey="image-upload-middel" fallback="Middel" />, value: 65 },
                        { label: () => <EditableContent contentKey="image-upload-hoej" fallback="Høj" />, value: 80 }, { label: () => <EditableContent contentKey="image-upload-maks" fallback="Maks" />, value: 95 }].map(p => (
