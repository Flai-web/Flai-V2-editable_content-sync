...
const Policies: React.FC<PoliciesProps> = () => {
  ...
  const renderPage = async (pageNum: number, container: HTMLDivElement) => {
    ...
    // Use full width, multiply by dpr for crisp rendering
  ...
  return (
    <div style={styles.container}>
      <div ref={viewerContainerRef} style={styles.viewerContainer}>
        {loading ? (
          <div style={styles.status}><p style={styles.statusText}>Loading Policies...</p></div>
        ) : error ? (
